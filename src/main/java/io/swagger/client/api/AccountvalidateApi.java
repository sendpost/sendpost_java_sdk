...
public class AccountvalidateApi {
    private ApiClient apiClient;

    public AccountvalidateApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AccountvalidateApi(ApiClient apiClient) {
    ...
    public com.squareup.okhttp.Call validateRouterValidateEmailBulkCall(File fileinput, String xAccountApiKey, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/account/validate/bulk";
    ...
    /**
     * Build call for validateRouterValidateEmailList
     * @param xAccountApiKey Account API Key (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call validateRouterValidateEmailListCall(String xAccountApiKey, ModelsEmailList body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call validateRouterValidateEmailListValidateBeforeCall(String xAccountApiKey, ModelsEmailList body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'xAccountApiKey' is set
        if (xAccountApiKey == null) {
            throw new ApiException("Missing the required parameter 'xAccountApiKey' when calling validateRouterValidateEmailList(Async)");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling validateRouterValidateEmailList(Async)");
        }
        

        com.squareup.okhttp.Call call = validateRouterValidateEmailListCall(xAccountApiKey, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ModelsCleanedList validateRouterValidateEmailList(String xAccountApiKey, ModelsEmailList body) throws ApiException {
        ApiResponse<ModelsCleanedList> resp = validateRouterValidateEmailListWithHttpInfo(xAccountApiKey, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ModelsCleanedList> validateRouterValidateEmailListWithHttpInfo(String xAccountApiKey, ModelsEmailList body) throws ApiException {
        com.squareup.okhttp.Call call = validateRouterValidateEmailListValidateBeforeCall(xAccountApiKey, body, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call validateRouterValidateEmailListAsync(String xAccountApiKey, ModelsEmailList body, final ApiCallback<ModelsCleanedList> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = validateRouterValidateEmailListValidateBeforeCall(xAccountApiKey, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ModelsCleanedList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
